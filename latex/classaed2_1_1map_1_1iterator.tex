...
\hypertarget{classaed2_1_1map_1_1iterator_a709df3d8aef6fd1eeb839616b554ff0b_a709df3d8aef6fd1eeb839616b554ff0b}{\index{aed2\-::map\-::iterator@{aed2\-::map\-::iterator}!iterator\-\_\-category@{iterator\-\_\-category}}
...
\hypertarget{classaed2_1_1map_1_1iterator_a4e1d954ef5c6a64bbcd881854f039a16_a4e1d954ef5c6a64bbcd881854f039a16}{\index{aed2\-::map\-::iterator@{aed2\-::map\-::iterator}!value\-\_\-type@{value\-\_\-type}}
...
\hypertarget{classaed2_1_1map_1_1iterator_ac19788914a3110897e44c53f1318f6af_ac19788914a3110897e44c53f1318f6af}{\index{aed2\-::map\-::iterator@{aed2\-::map\-::iterator}!reference@{reference}}
...
\hypertarget{classaed2_1_1map_1_1iterator_a52ea7bdbf1dc6b252aec76633564bdf5_a52ea7bdbf1dc6b252aec76633564bdf5}{\index{aed2\-::map\-::iterator@{aed2\-::map\-::iterator}!pointer@{pointer}}
...
\hypertarget{classaed2_1_1map_1_1iterator_a803083681db1f62aed5138194abc1f06_a803083681db1f62aed5138194abc1f06}{\index{aed2\-::map\-::iterator@{aed2\-::map\-::iterator}!difference\-\_\-type@{difference\-\_\-type}}
...
\paragraph[{iterator}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Key, class Meaning, class Compare = std\-::less$<$\-Key$>$$>$ {\bf aed2\-::map}$<$ Key, Meaning, Compare $>$\-::iterator\-::iterator (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classaed2_1_1map_1_1iterator_acdd790eb54216601a2e0591776004dba_acdd790eb54216601a2e0591776004dba}
...
\item[{Node $\ast$}]{pos}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [private]}}}\label{classaed2_1_1map_1_1iterator_ab0ea21abcb32b6d5a72cf341b9029838_ab0ea21abcb32b6d5a72cf341b9029838}
...
Definición en la línea \hyperlink{map_8h_source_l02519}{2519} del archivo \hyperlink{map_8h_source}{map.\-h}.
...
\paragraph[{operator$\ast$}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Key, class Meaning, class Compare = std\-::less$<$\-Key$>$$>$ {\bf reference} {\bf aed2\-::map}$<$ Key, Meaning, Compare $>$\-::iterator\-::operator$\ast$ (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}}\label{classaed2_1_1map_1_1iterator_a48e75896997d516fe69bc18f889222fe_a48e75896997d516fe69bc18f889222fe}
...
\end{DoxyRetVals}
\begin{DoxyParagraph}{Aspectos de aliasing\-:}
Como se devuelve una referencia, cualquier cambio en {\bfseries res} afectará la estructura subyacente y viceversa.
\end{DoxyParagraph}
\begin{DoxyPrecond}{Precondición}
{\bfseries P} $\equiv$ \{{\itshape self} = {\bfseries this}\} 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondición}
{\bfseries Q} $\equiv$ \{{\bfseries res} $=_{\rm obs}$ {\bfseries $\ast$this} $\land$ {\itshape self} = {\bfseries this}\}
\end{DoxyPostcond}
...
\paragraph[{operator-\/$>$}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Key, class Meaning, class Compare = std\-::less$<$\-Key$>$$>$ {\bf pointer} {\bf aed2\-::map}$<$ Key, Meaning, Compare $>$\-::iterator\-::operator-\/$>$ (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}}\label{classaed2_1_1map_1_1iterator_a227de3b56a6ff2e6bb6de2d08277ca60_a227de3b56a6ff2e6bb6de2d08277ca60}
...
\end{DoxyRetVals}
\begin{DoxyParagraph}{Aspectos de aliasing\-:}
Como devuelve un puntero a un elemento de la estructura, cualquier cambio en {\bfseries res} afectará a la estructura subyacente y viceversa.
\end{DoxyParagraph}
\begin{DoxyPrecond}{Precondición}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classaed2_1_1map_1_1iterator_a7c44de7f0508186e135ddbcfe782fec5_a7c44de7f0508186e135ddbcfe782fec5}
...
\end{DoxyRetVals}
\begin{DoxyParagraph}{Aspectos de aliasing\-:}
Como devuelve una referencia, cualquier cambio en {\bfseries res} afecta a la estructura subyacente y viceversa. En caso de eliminarse de la estructura el valor apuntado por {\bfseries this}, {\bfseries res} se invalida.
\end{DoxyParagraph}
\begin{DoxyPrecond}{Precondición}
{\bfseries P} $\equiv$ \{{\itshape self} = {\bfseries res} $\land$ Hay\-Siguiente?({\bfseries this})\} 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondición}
{\bfseries Q} $\equiv$ \{{\bfseries this} = Avanzar({\itshape self}) $\land$ {\bfseries res} = {\bfseries this}\}
\end{DoxyPostcond}
...
\item[{int}]{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classaed2_1_1map_1_1iterator_af4fe5565eb478cfccd254b2ef230b974_af4fe5565eb478cfccd254b2ef230b974}
...
\end{DoxyRetVals}
\begin{DoxyParagraph}{Aspectos de aliasing\-:}
Como devuelve un iterador a la estructura, cualquier cambio en el valor apuntado por {\bfseries res} afectará la estructura subyacente y viceversa. En caso de eliminarse el valor apuntado por {\bfseries res}, {\bfseries res} se invalida.
\end{DoxyParagraph}
\begin{DoxyPrecond}{Precondición}
{\bfseries P} $\equiv$ \{{\itshape self} = {\bfseries res} $\land$ Hay\-Siguiente?({\bfseries this})\} 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondición}
{\bfseries Q} $\equiv$ \{{\bfseries this} = Avanzar({\itshape self}) $\land$ {\bfseries res} = {\itshape self\}} 
\end{DoxyPostcond}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classaed2_1_1map_1_1iterator_ae7f70f71545d2a9de17b65edaaec748a_ae7f70f71545d2a9de17b65edaaec748a}
...
\end{DoxyParagraph}
\begin{DoxyPrecond}{Precondición}
{\bfseries P} $\equiv$ \{{\itshape self} = {\bfseries res} $\land$ Hay\-Anterior?({\bfseries this})\} 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondición}
{\bfseries Q} $\equiv$ \{{\bfseries this} = Retroceder({\itshape self}) $\land$ {\bfseries res} = {\bfseries this}\}
\end{DoxyPostcond}
...
Definición en la línea \hyperlink{map_8h_source_l02438}{2438} del archivo \hyperlink{map_8h_source}{map.\-h}.
...
\item[{int}]{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classaed2_1_1map_1_1iterator_add45e9ddbb8eeda99326cdb9ac9dd225_add45e9ddbb8eeda99326cdb9ac9dd225}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondición}
{\bfseries Q} $\equiv$ \{{\bfseries this} = Retroceder({\itshape self}) $\land$ {\bfseries res} = {\itshape self\}} 
\end{DoxyPostcond}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}}\label{classaed2_1_1map_1_1iterator_ad052c1ef8477a1613c292202226053a5_ad052c1ef8477a1613c292202226053a5}
...
\item[{{\bf iterator}}]{other}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}}\label{classaed2_1_1map_1_1iterator_a836c7a166d63f507c4f79085ae953c51_a836c7a166d63f507c4f79085ae953c51}
...
\paragraph[{operator Node $\ast$}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Key, class Meaning, class Compare = std\-::less$<$\-Key$>$$>$ {\bf aed2\-::map}$<$ Key, Meaning, Compare $>$\-::iterator\-::operator Node $\ast$ (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [private]}}}\label{classaed2_1_1map_1_1iterator_a7fe2cdc033cd899dc9fd1da08ac3b39e_a7fe2cdc033cd899dc9fd1da08ac3b39e}
...
\hypertarget{classaed2_1_1map_1_1iterator_adf8633ef71bb6c1fc01c0abe8728fd93_adf8633ef71bb6c1fc01c0abe8728fd93}{\index{aed2\-::map\-::iterator@{aed2\-::map\-::iterator}!n@{n}}
