...
( $\forall$ n\+:puntero(nodo)) abs\+\_\+iter(n) $=_{\rm obs}$ i\+:Iterador\+Bidireccional $\vert$ (n $=_{\rm obs}$ nullptr $\land$ Anteriores(i) \textbackslash{} I\+G\+O\+BS vacía $\land$ Siguientes(i) $=_{\rm obs}$ vacía) $\lor_{\rm L}$ (\href{axiomas.html#inorder}{\tt inorder}(\href{axiomas.html#buscarRaiz}{\tt buscar\+Raiz}(n)) $=_{\rm obs}$ Secu\+Suby(i) $\land_{\rm L}$ Siguientes(i) $=_{\rm obs}$ \href{axiomas.html#despuesDe}{\tt despues\+De}(n-\/$>$value,Secu\+Suby(i)) $\land$ Anteriores(i) $=_{\rm obs}$ (n-\/$>$value,Secu\+Suby(i)))
...
\hline
\end{DoxyRetVals}
\{Como se devuelve una referencia, cualquier cambio en \{res\} afectará la estructura subyacente y viceversa.

\begin{DoxyPrecond}{Precondición}
\{{\itshape self} = \{this\}\} 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondición}
\{\{res\}  \{$\ast$this\}  {\itshape self} = \{this\}\}
\end{DoxyPostcond}
\{(1)\} 

Definición en la línea \hyperlink{map_8h_source_l02515}{2515} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l02629}{2629} del archivo \hyperlink{map_8h_source}{map.\+h}.
